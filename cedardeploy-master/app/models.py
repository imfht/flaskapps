...
class serverinfo(db.Model):
    ...
    def __init__(self, project, hostname, ip, pnum, env, checkstatus, checktime, commitid, updatestatus, updatetime):
...
class projectinfo(db.Model):
    ...
    def __init__(self, project, group, environment, p, codetype, port, git, branch, checkport, checkhttp, httpurl, httpcode, make, supervisor, config, remarks):
        self.project = project
        self.group = group
...
class updateoperation(db.Model):
    ...
    def __init__(self, taskid, project, hostlist, tag, rtime, operation, user, status, commitid, progress, logpath):
        self.taskid = taskid
        self.project = project
